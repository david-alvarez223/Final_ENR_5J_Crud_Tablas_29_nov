...
def registerClient(request):
    ...
    client_freq=request.POST["txtfreq"]
    client_rating=request.POST["numrating"]

    saveClient=Client.objects.create(client_id=client_id,client_name=client_name,client_rating=client_rating,client_freq=client_freq)#GUARDA EL REGISTRO
...
def editClient(request):
    ...
    clients.client_freq=client_freq
